  ...
  return (
    <div className="p-5 md:p-8 space-y-6 max-w-lg">
      ...
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-text-secondary mt-0.5">
            Mensalidades, pagamentos e histórico financeiro.
          </p>
        </div>
      </div>
      ...
      <div className="bg-surface border border-surface-border rounded-2xl p-10 flex flex-col items-center text-center gap-5">
        <div className="w-16 h-16 rounded-2xl bg-sky-400/10 border border-sky-400/20 flex items-center justify-center">
          <Receipt size={28} className="text-sky-400" />
        </div>

        <div className="space-y-2">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-sky-400/10 border border-sky-400/20 text-sky-400 text-xs font-display font-bold uppercase tracking-widest">
            <Clock size={11} />
            Em breve
          </div>
          ...
          <p className="text-sm text-text-secondary max-w-xs">
            Aqui você poderá acompanhar suas mensalidades, datas de vencimento e histórico de pagamentos.
          </p>
        </div>

        <ul className="w-full max-w-xs space-y-2 text-left">
          {[
            'Visualizar mensalidades em aberto',
