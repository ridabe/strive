...
## Corpus Check
- 8 files · ~2,306,736 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3824 nodes · 7855 edges · 239 communities (200 shown, 39 thin omitted)
...
Cohesion: 0.04
Nodes (59): addExtraWorkoutItem(), groupExtraWorkoutItems(), removeExtraWorkoutItem(), reorderExtraWorkoutItems(), ungroupExtraWorkoutItems(), updateExtraWorkoutItem(), ExtraWorkoutItemData, updateProfile() (+51 more)
...
Cohesion: 0.05
Nodes (64): createStudent(), resendStudentInvite(), updateStudent(), createModule(), disableAllModulesForTenant(), enableAllModulesForTenant(), ModuleCategory, ModuleStatus (+56 more)
...
Cohesion: 0.09
Nodes (26): addWorkoutItem(), ExerciseRow, groupWorkoutItems(), removeWorkoutItem(), reorderWorkoutItems(), searchExercises(), ungroupWorkoutItems(), updateWorkoutItem() (+18 more)
...
Cohesion: 0.10
Nodes (18): createWorkoutPlan(), deleteWorkoutPlan(), getWorkoutPlan(), publishWorkoutPlan(), WorkoutPlanWithRoutines, createRoutine(), RoutineCard(), Props (+10 more)
...
Cohesion: 0.07
Nodes (28): dependencies, class-variance-authority, clsx, date-fns, @hookform/resolvers, lucide-react, next, @radix-ui/react-avatar (+20 more)

### Community 41 - "Community 41"
Cohesion: 0.11
Nodes (22): getFoodItems(), addMealFood(), assignMealPlanToStudents(), createMealPlan(), deleteMealFood(), deleteMealPlan(), getActiveStudentsForMealPlan(), getAssignmentsForMealPlan() (+14 more)
...
Cohesion: 0.15
Nodes (18): finishWorkoutSession(), getExerciseLoadHistory(), getStudentCompletedRoutineIds(), getStudentCtx(), getStudentWorkoutCount(), getStudentWorkoutHistory(), saveSessionExercise(), startWorkoutSession() (+10 more)
...
Cohesion: 0.16
Nodes (16): assignPlanToAllStudents(), assignPlanToStudents(), getActiveStudentsForTenant(), getAssignmentsForPlan(), getPersonalCtx(), getUnassignedPlansForStudent(), removePlanAssignment(), GOAL_COLOR (+8 more)
...
Cohesion: 0.18
Nodes (10): AdminLayout(), AdminMobileNav(), QUICK_ITEMS, AdminSidebarNav(), NAV_ITEMS, NavItem, SidebarNavProps, BOTTOM_ITEMS (+2 more)
...
Cohesion: 0.18
Nodes (8): getClientIp(), redirectByRole(), signIn(), signUpPersonal(), createClient_action(), LogoUpload(), AuthSubmitButton(), AuthSubmitButtonProps
...
Cohesion: 0.15
Nodes (9): FAQS, MAX_FEATURES, MODULES, NAV_LINKS, PLANS, STEPS, MobileNav(), MobileNavProps (+1 more)
...
Cohesion: 0.15
Nodes (13): devDependencies, autoprefixer, canvas, eslint, eslint-config-next, postcss, @resvg/resvg-js, sharp (+5 more)
...
Cohesion: 0.22
Nodes (7): dmSans, getAndroidStoreUrl(), metadata, RootLayout(), syncopate, viewport, AndroidInstallPrompt()
...
Cohesion: 0.24
Nodes (6): saveBranding(), PRESET_COLORS, Props, BrandingForm(), PRESET_COLORS, Props
...
Cohesion: 0.36
Nodes (7): dismissTrainerNotification(), getTrainerNotifications(), TrainerNotification, DashboardLayout(), DashboardMobileNav(), Props, TrainerNotificationBell()
...
Cohesion: 0.28
Nodes (7): signOut(), AdminMobileNavProps, DashboardMobileNavProps, QUICK_ITEMS, ROLE_LABELS, UserMenuProps, AppRole
...
Cohesion: 0.50
Nodes (4): ArquivosStudentPage(), FileCard(), fmtSize(), SharedFile
...
## Knowledge Gaps
- **893 isolated node(s):** `extends`, `fs`, `{ createClient }`, `env`, `sb` (+888 more)
...
- **Why does `confirm()` connect `Community 26` to `Community 22`?**
  _High betweenness centrality (0.069) - this node is a cross-community bridge._
- **Why does `createClient()` connect `Community 2` to `Community 4`, `Community 5`, `Community 134`, `Community 151`, `Community 29`, `Community 30`, `Community 158`, `Community 35`, `Community 37`, `Community 45`, `Community 174`, `Community 48`, `Community 176`, `Community 50`, `Community 54`, `Community 55`, `Community 63`, `Community 71`, `Community 72`, `Community 73`, `Community 83`, `Community 84`, `Community 89`, `Community 100`, `Community 102`, `Community 103`, `Community 107`, `Community 108`, `Community 114`, `Community 115`, `Community 124`, `Community 126`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `pickVariantContent()` connect `Community 53` to `Community 0`, `Community 3`, `Community 47`?**
...
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.045444982116557966 - nodes in this community are weakly interconnected._
