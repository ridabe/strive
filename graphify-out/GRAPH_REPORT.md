...
## Corpus Check
- 1 files · ~2,313,511 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4513 nodes · 8673 edges · 270 communities (238 shown, 32 thin omitted)
...
1. `createClient()` - 223 edges
2. `getCtx()` - 58 edges
3. `createAdminClient()` - 38 edges
4. `runHook()` - 30 edges
5. `requirePersonalCtx()` - 29 edges
...
Cohesion: 0.04
Nodes (62): assignTemplateToStudent(), createExtraWorkout(), deleteExtraWorkout(), ExtraWorkoutWithItems, getStudentExtraWorkouts(), getTenantExtraWorkouts(), updateExtraWorkout(), GET() (+54 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (94): borderColorsFromStyle(), borderWidthsFromStyle(), checkBorders(), checkClippedOverflow(), checkColors(), checkCreamPalette(), checkElementAIPaletteDOM(), checkElementBorders() (+86 more)
...
Cohesion: 0.05
Nodes (44): createWorkoutPlan(), deactivateWorkoutPlan(), deleteWorkoutPlan(), getStudentWorkoutPlans(), getWorkoutPlan(), updateWorkoutPlan(), WorkoutPlanWithRoutines, finishWorkoutSession() (+36 more)

### Community 7 - "Community 7"
Cohesion: 0.06
Nodes (43): createStudent(), resendStudentInvite(), updateStudent(), activateUser(), createGlobalAdmin(), deleteUser(), generateTempPassword(), getTenantInviteContext() (+35 more)
...
Cohesion: 0.09
Nodes (42): detectCli(), formatFindings(), formatFindingSummary(), handleStdin(), printUsage(), createBrowserDetector(), CSS_IN_JS_EXTENSIONS, detectText() (+34 more)
...
Cohesion: 0.06
Nodes (41): addExtraWorkoutItem(), groupExtraWorkoutItems(), removeExtraWorkoutItem(), reorderExtraWorkoutItems(), ungroupExtraWorkoutItems(), updateExtraWorkoutItem(), ExtraWorkoutItemData, addWorkoutItem() (+33 more)

### Community 12 - "Community 12"
Cohesion: 0.06
Nodes (40): getClientIp(), redirectByRole(), signIn(), signOut(), createModule(), disableAllModulesForTenant(), enableAllModulesForTenant(), ModuleCategory (+32 more)

### Community 13 - "Community 13"
Cohesion: 0.06
Nodes (39): activateClient(), createClient_action(), deleteClient(), resendWelcomeEmail(), suspendClient(), updateClient(), updateProfile(), ClientDetailPage() (+31 more)
...
Cohesion: 0.06
Nodes (42): AbacatePay (PIX + Cartão), /admin/* (Painel administrativo), Arquitetura (Stack, Auth, Payments, Deploy), src/lib/admin/audit.ts, createAbacatePay() (não existe), createAbacateProduct(), createSubscriptionCheckout(), /dashboard/* (Painel do personal trainer) (+34 more)

### Community 23 - "Community 23"
Cohesion: 0.08
Nodes (28): applyStaticDeclaration(), buildBorderOverrideMap(), buildStaticWindow(), collectStaticCssText(), compareStaticPriority(), cssPropToCamel(), expandStaticBoxValues(), expandStaticDeclaration() (+20 more)
...
Cohesion: 0.08
Nodes (18): signUpPersonal(), AlterarSenhaPage(), AjustesPage(), FAQS, HomePage(), MAX_FEATURES, MODULES, NAV_LINKS (+10 more)

### Community 40 - "Community 40"
Cohesion: 0.07
Nodes (30): Apply Clarity Principles, Assess Current Copy, Avoid Redundant Copy, Button & CTA Text, Confirmation Dialogs, Confirmation Dialogs: Use Sparingly, Consistency: The Terminology Problem, Don't Blame the User (+22 more)
...
Cohesion: 0.11
Nodes (19): AssistenteIaPage(), Props, StudentMessagesPage(), StudentMessageItem, StudentMessagesClient(), StudentMessagesClientProps, MaxChatPanel(), Message (+11 more)
...
Cohesion: 0.12
Nodes (18): ChallengeMessage, deleteChallenge(), finishChallenge(), ParticipantTracking, sendChallengeMessage(), DayWithItems, ParticipantRow, Props (+10 more)
...
Cohesion: 0.18
Nodes (18): addMeal(), addMealFood(), assignMealPlanToStudents(), createMealPlan(), deactivateMealPlan(), deleteMeal(), deleteMealFood(), deleteMealPlan() (+10 more)
...
Cohesion: 0.12
Nodes (15): STATIC_ELEMENT_RULES, checkElementGlow(), checkPageQualityDOM(), checkPageQualityFromDoc(), checkTypography(), BORDER_SAFE_TAGS, BRAND_FONT_DOMAINS, GENERIC_FONTS (+7 more)
...
Cohesion: 0.13
Nodes (13): AdminMobileNav(), DashboardMobileNav(), NavItem, SidebarNavProps, BOTTOM_ITEMS, BASE_NAV_ITEMS, CHALLENGES_ITEM, getStudentNavItems() (+5 more)
...
Cohesion: 0.15
Nodes (14): getExtraWorkout(), ExtraWorkoutBuilder(), CATEGORY_COLOR, CATEGORY_LABEL, Props, TreinoExtraPage(), CATEGORY_COLOR, CATEGORY_LABEL (+6 more)
...
Cohesion: 0.17
Nodes (13): createFoodItem(), deleteFoodItem(), FoodItem, updateFoodItem(), calcFood(), DraftFood, DraftMeals, fmt() (+5 more)
...
Cohesion: 0.14
Nodes (13): CompositeTypes, Constants, Database, DatabaseWithoutInternals, DefaultSchema, Enums, ExtraWorkoutCategory, Json (+5 more)
...
Cohesion: 0.19
Nodes (11): DashboardMobileNavProps, QUICK_ITEMS, CORE_BOTTOM, CORE_TOP, DashboardSidebarNav(), EnabledModule, ICON_MAP, MODULE_GROUPS (+3 more)
...
Cohesion: 0.22
Nodes (11): getFoodItems(), getActiveStudentsForMealPlan(), getAssignmentsForMealPlan(), getMealPlan(), GOAL_COLOR, PlanoAlimentarPage(), Props, Assignment (+3 more)

### Community 126 - "Community 126"
Cohesion: 0.27
Nodes (9): AdminLayout(), AdminMobileNavProps, QUICK_ITEMS, AdminSidebarNav(), NAV_ITEMS, ROLE_LABELS, UserMenu(), UserMenuProps (+1 more)
...
Cohesion: 0.28
Nodes (5): saveBranding(), PRESET_COLORS, Props, PRESET_COLORS, Props
...
Cohesion: 0.50
Nodes (3): publishChallengeResults(), Props, PublishResultsButton()
...
## Knowledge Gaps
- **1401 isolated node(s):** `COMMON_DEV_PORTS`, `SCANNABLE_EXT`, `SOURCE_DIRS`, `PRODUCT_NAMES`, `DESIGN_NAMES` (+1396 more)
...
- **Why does `recordProfileEvent()` connect `Community 66` to `Community 13`, `Community 23`?**
  _High betweenness centrality (0.210) - this node is a cross-community bridge._
- **Why does `Profile` connect `Community 13` to `Community 66`?**
  _High betweenness centrality (0.210) - this node is a cross-community bridge._
- **Why does `confirm()` connect `Community 33` to `Community 9`?**
...
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.038081211866189776 - nodes in this community are weakly interconnected._
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.04596219931271478 - nodes in this community are weakly interconnected._